...
public class LoginController extends BaseController {
	...
	public ModelAndView login_index(@PathVariable("changeMenu") String changeMenu){
		...
		try{
			...
			if (user != null) {
				...
				List<Menu> menuList = getMenu(changeMenu, session, roleRights);
				//切换菜单=====
	...
	private List<Menu> getMenu(String changeMenu, Session session, String roleRights) throws Exception {
