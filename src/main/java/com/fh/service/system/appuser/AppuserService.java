...
public class AppuserService {
	...
	*/
	public PageData findByMobile(PageData pd)throws Exception{
		return (PageData)dao.findForObject("AppuserMapper.findByMobile", pd);
	}
	...
	*用户列表(全部)
	*/
	public List<PageData> listAllUserId()throws Exception{
		return (List<PageData>) dao.findForList("AppuserMapper.listAllUserId", new PageData());
	}
	...
	*/
	...
	public void editByUID(PageData pd)throws Exception{
		dao.update("AppuserMapper.editByUID", pd);
	}
